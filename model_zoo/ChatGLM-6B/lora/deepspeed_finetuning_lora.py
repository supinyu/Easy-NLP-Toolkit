...
# @Time    : 2023/5/9 18:10
# @Author  : supinyu
# @File    : deepspeed_finetuning_lora.py


from transformers import AutoTokenizer, AutoModel
from data_util import GLMDataSet, data_collator
import torch
import deepspeed
import argparse
...
def main():
    ...
    train_dataset = GLMDataSet(args.train_path, tokenizer, args.max_len, args.max_src_len,
                                            args.prompt_text)
